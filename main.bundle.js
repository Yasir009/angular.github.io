...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__lorem_impsum_lorem_impsum_component__ = __webpack_require__("./src/app/lorem-impsum/lorem-impsum.component.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_4__lorem_impsum_lorem_impsum_component__["a" /* LoremImpsumComponent */],
...
/***/ "./src/app/lorem-impsum/lorem-impsum.component.css":
/***/ (function(module, exports) {

module.exports = ".clsRed{\r\n    color: red;\r\n}\r\n.clsBlue {\r\n    color:blue;\r\n}\r\n.clsGreen{\r\n    color: green;\r\n}"

/***/ }),

/***/ "./src/app/lorem-impsum/lorem-impsum.component.html":
/***/ (function(module, exports) {

module.exports = "<h2 [class]=\"cls\">\n Welcome, {{UserName}}\n <br>\n <input type=\"text\" [(ngModel)]=\"UserName\" [placeholder]=\"defaultPlaceholder\">\n <br>\n <p>You clicked {{times}} Times</p>\n <button (click)=\"increaseClick()\">Click Me!</button>\n</h2>\n<p *ngIf=\"show\">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Optio nihil, voluptate sapiente repellat eveniet praesentium delectus, fugit placeat aliquid quis ut sequi non impedit, quo aperiam! Provident tempore nihil iure? </p>\n\n<p *ngIf=\"show; then thenBlock else elseBlock\"></p>\n\n<ng-template #thenBlock>\n    <h2>Then Block Exected...</h2>\n</ng-template>\n<ng-template #elseBlock>\n    <h2>Else block Executed...</h2>\n</ng-template>\n<p>\n    <button (click)=\"changeBlock()\">{{show?'Hide':'Show'}}</button>\n</p>\n<p [class]=\"clsR\">without ngClass Directive we can't call more than 1 classes</p>\n<p [ngClass]=\"colors\">with ngClass Directive Implementation we can use more than 1 classes at a time</p>\n<p [ngStyle]=\"{'color':'red','font-size':'25px'}\">ngStyling</p>\n<p [ngStyle]=\"sObject\">Inline styling via object from ts file</p>\n<h3 [ngStyle]=\"{'color': fColor,'font-size.px':fSize}\">Testing radio Buttons </h3>\n<p>\n<input type=\"radio\" name=\"d\" id=\"\" (change)=\"changeColor('red')\">Red\n<br/>\n<input type=\"radio\" name=\"d\" id=\"\" (change)=\"changeColor('green')\">Green\n<br/>\n<input type=\"radio\" name=\"d\" id=\"\" (change)=\"changeColor('blue')\">Blue\n<br/>\n<input type=\"number\" id=\"\" [(ngModel)]='fSize'>\n</p>\n    <p>\n    \n        <input type=\"number\" name=\"\" id=\"\" [(ngModel)]=\"showView\">\n    </p>\n    <div [ngSwitch]=\"showView\">\n        <p *ngSwitchCase=\"1\">This is Block 1</p>\n        <p *ngSwitchCase=\"2\">This is Block 2</p>\n        <p *ngSwitchCase=\"3\">This is Block 3</p>\n        <p *ngSwitchCase=\"4\">This is Block 4</p>\n        <p *ngSwitchDefault>This is Default Block</p>\n    </div>\n    <div>\n            <ul>\n                <li *ngFor=\"let item of myArr; let i=index\">\n                {{item}} \n                </li>\n            </ul>\n        </div>"

/***/ }),

/***/ "./src/app/lorem-impsum/lorem-impsum.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LoremImpsumComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var LoremImpsumComponent = /** @class */ (function () {
    function LoremImpsumComponent() {
        this.UserName = "Muhammad Yasir Bilal";
        this.cBlue = "clsBlue";
        this.cRed = "clsRed";
        this.cGreen = "clsGreen";
        this.defaultValue = "Yasir";
        this.defaultPlaceholder = "First Name";
        this.times = 0;
        /*colors=[
          this.cBlue,this.cRed,this.cGreen
        ]*/
        this.colors = {
            clsGreen: true,
            clsBlue: false,
        ...
        this.show = false; //show is a property whose default value is false
        this.fColor = "";
        this.fSize = 30;
        this.showView = 0;
        this.myArr = [
    ...
    LoremImpsumComponent.prototype.ngOnInit = function () {
    };
    LoremImpsumComponent.prototype.increaseClick = function () {
        this.times++;
    };
    LoremImpsumComponent.prototype.changeBlock = function () {
        this.show = !this.show;
    };
    LoremImpsumComponent.prototype.changeColor = function (val) {
        this.fColor = val;
    };
    LoremImpsumComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-lorem-impsum',
            template: __webpack_require__("./src/app/lorem-impsum/lorem-impsum.component.html"),
            styles: [__webpack_require__("./src/app/lorem-impsum/lorem-impsum.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], LoremImpsumComponent);
    return LoremImpsumComponent;
}());
